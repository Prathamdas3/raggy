...
class ChatService:
    ...
    def update_chat(self, data: UpdateChat) -> str:
        ...
        chat = self._find_chat(data.chat_id)
    ...
    def create_branch(self, chat_id: UUID, parent_branch_id: UUID | None = None) -> UUID:
        self._find_chat(chat_id)  # validates chat exists
