...
async def upload_file(
    ...
    try:
        ...
        original_doc = await save_upload_to_minio(filename=meta.filename,content_type=meta.content_type,file_bytes=file_bytes)
        if not original_doc:
            logger.error(
        ...
        chat_id =await chat_services.create_chat(
