...
logger = get_logger("workers/upload_answer_audio_to_minio")
...
def upload_audio_to_minio(self, temp_file_path: str, chat_id: str, question_id: str):
    ...
    Args:
        ...
        question_id: The question ID for storing in the db
    ...
    try:
        ...
        try:
            from workers.db.store_answer_audio import store_answer_audio_to_db
