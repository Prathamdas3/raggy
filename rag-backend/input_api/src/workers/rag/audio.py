...
def convert_text_to_audio(self, text: str, chat_id: str):
    ...
    try:
        logger.info(f"Starting text-to-audio conversion for chat_id: {chat_id}")
        ...
        logger.info(f"Creating audio file at: {temp_file_path}")
        ...
        try:
            from workers.rag.upload_audio_minio import upload_audio_to_minio
